...
public partial class Roster_ : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            SqlCommand com = new SqlCommand("SELECT distinct Selected_Jobs from JobContractCasual j,Employee e " +
            ...
            DropDownList2.DataTextField = "Selected_Jobs";
            DropDownList2.DataValueField = "Selected_Jobs";
    ...
    {
        string JID = "";
        SqlCommand cmd1 = new SqlCommand("SELECT distinct * FROM JobContractCasual WHERE Selected_Jobs = '" + DropDownList2.Text + "' AND EID = '" + DropDownList1.SelectedValue + "'",con);
        ...
        {
            JID = sqlDataReader.GetInt32(sqlDataReader.GetOrdinal("JID")).ToString();
            Debug.WriteLine(JID);
        ...
        SqlCommand cmd = new SqlCommand(" Insert Into AssignRoster(" +
           "EID," +
           "Job," +
           "JLocation," +
           "JLocation_lat," +
    ...
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("(SELECT distinct e.Ename,j.EID " +
            ...
            "WHERE j.EID=e.EID and j.Selected_Jobs= '" + value + "' and e.CompanyID = '"+ UserID + "')", con);
        // table name  
