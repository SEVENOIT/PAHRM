<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PaySalary.aspx.cs" Inherits="PaySalary" EnableEventValidation="false" %>
			...
			<div class="col-xl-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="theme-form">
							...
							<div class="mb-3 row">
								...
								<asp:Label ID="Label3" class="col-sm-3 col-form-label" runat="server" Text="Job Contract Type"></asp:Label>

								<div class="col-sm-9">

									<asp:DropDownList ID="TextBox2" runat="server" Width="31%" CssClass="form-control" ReadOnly="true">
					...
					<div runat="server" id="div1">
						<div>
							<asp:GridView ID="Grid" runat="server" PageSize="10" DataKeyField="EID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" ItemStyle-BorderStyle="Solid" OnRowCommand="Grid_RowCommand" CssClass="grid">
								<Columns>
									...
									<asp:BoundField HeaderText="Job" DataField="Selected_Jobs"></asp:BoundField>

 									<asp:BoundField HeaderText="Worked Hours(h)" DataField="WorkedHours"></asp:BoundField>
									<asp:BoundField HeaderText="Hourly Rate" DataField="Hourly_rate"></asp:BoundField>
									<asp:BoundField HeaderText="Job Contract Type" DataField="ContractType"></asp:BoundField>
									<asp:BoundField HeaderText=" Gross Payment" DataField="Payment"></asp:BoundField>
									<asp:BoundField HeaderText=" Tax Deduction" DataField="TaxDeduction"></asp:BoundField>
									<asp:BoundField HeaderText=" Net Salary" DataField="NetPay"></asp:BoundField>
									<asp:TemplateField HeaderText="Pay Now">
										<ItemTemplate>
											<asp:Button Text="Pay" runat="server" CssClass="btn btn-primary" CommandName="Pay" CommandArgument="<%# Container.DataItemIndex %>" />
										</ItemTemplate>
									</asp:TemplateField>
						...
						<div>
							<asp:GridView ID="GridView1" runat="server" PageSize="10" DataKeyField="EID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" ItemStyle-BorderStyle="Solid" OnRowCommand="Grid_RowCommand" CssClass="grid">
								<Columns>
									<%--<asp:BoundField HeaderText="Employee ID" DataField="EId" ID="EId"></asp:BoundField>--%>
									<asp:TemplateField HeaderText="Employee ID" ItemStyle-Width="150">
										<ItemTemplate>
									...
									<asp:BoundField HeaderText="Employee Name" DataField="Ename"></asp:BoundField>
									<asp:BoundField HeaderText="Designation" DataField="Designation"></asp:BoundField>

 									<asp:BoundField HeaderText="Basic Salary" DataField="Salary"></asp:BoundField>
