<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeRegistrationProfile.aspx.cs" Inherits="EmployeeRegistrationProfile" %>
						...
						<div id="mainnav">
							<ul class="nav-menu custom-scrollbar">
								...
								<li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="layout"></i><span>Reports</span></a>
									<ul class="nav-submenu menu-content">
										<li>
											<asp:Button   runat="server" OnClick="Interview" class="btn btn-outline-light txt-dark" Style="margin: 10px;" Text="Employee" /></li>
										<li>
											<asp:Button   runat="server" OnClick="Interview" class="btn btn-outline-light txt-dark" Style="margin: 10px;" Text="Payroll" /></li>
										<li>
											<asp:Button   runat="server" OnClick="Interview" class="btn btn-outline-light txt-dark" Style="margin: 10px;" Text="Roster" /></li>
										<li>
											<asp:Button   runat="server" OnClick="Interview" class="btn btn-outline-light txt-dark" Style="margin: 10px;" Text="Leave managment" /></li>
										<li>
											<asp:Button   runat="server" OnClick="Interview" class="btn btn-outline-light txt-dark" Style="margin: 10px;" Text="Attendance" /></li>
									</ul>
								</li>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form class="theme-form">
							...
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Templorary ID</label>
								<div class="col-sm-9">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<asp:TextBox ID="TextBox19" ReadOnly="true"  runat="server" class="form-control" type="text" data-language="en" />
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Gender</label>
								<div class="col-sm-9">
									<asp:TextBox ID="TextBox6" ReadOnly="true"  runat="server" class="form-control" />
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="TextBox3"   runat="server" ReadOnly="true" type="text" />
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Language</label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="TextBox21" ReadOnly="true"  runat="server" type="text" />
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									...
									<asp:TextBox ID="TextBox13" ReadOnly="true"  runat="server" class="form-control" ></asp:TextBox>

								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Visa Status</label>
								<div class="col-sm-9">
									<asp:TextBox ID="TextBox15" ReadOnly="true"  runat="server" class="form-control" ></asp:TextBox>
								</div>
							</div>
							<div class="mb-3 row" id="other" runat="server">
								<label class="col-sm-3 col-form-label" id="Label22a" >Give Other Reasons</label>
								<div id="TextBox20a" class="col-sm-9" style="visibility: hidden">
									<asp:TextBox ID="TextBox20" ClientIDMode="Static" ReadOnly="true"  runat="server" class="form-control"></asp:TextBox>
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >ID Number/Drivers License Number</label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="TextBox28" ReadOnly="true"  runat="server" type="text" />
								</div>
							</div>
							<h5>Contact Information</h5>
							<hr />
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Pesonal Mobile Number</label>
								<div class="col-sm-9">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="TextBox14" ReadOnly="true"  runat="server" type="text" />
								</div>
							</div>
							<div class="mb-3 row">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="TextBox10" ReadOnly="true"  runat="server" type="text" />
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Relation Name</label>
								<div class="col-sm-9">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="TextBox12" ReadOnly="true"  runat="server" type="text" />
								</div>
							</div>
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="TextBox33" MaxLength="500" ReadOnly="true"  runat="server" Rows="2" />
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Other Qualifications</label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" id="otherQ" maxlength="500" ReadOnly="true"  runat="server" rows="3" />
								</div>
							</div>
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<asp:TextBox ID="TextBox16" ReadOnly="true"  runat="server" class="form-control"  ></asp:TextBox>

								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Special Requrements</label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" id="TextBox29" ReadOnly="true"  runat="server" maxlength="500" rows="2" />
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Other Requrements</label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" id="TextBox23" maxlength="500"   ReadOnly="true"  runat="server" rows="3" />
								</div>
							</div>
							<h5>Job Contract</h5>
							<hr />
							<div class="mb-3 row">
								<asp:Label ID="Label8"   ReadOnly="true"  runat="server" class="col-sm-3 col-form-label" >Designation</asp:Label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="desig"  ReadOnly="true"  runat="server" type="text" />
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Working Experiance</label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="experiance"  ReadOnly="true"  runat="server" type="text" />
								</div>
							</div>
							<div class="mb-3 row">
								<asp:Label ID="Label10" ReadOnly="true"  runat="server" class="col-sm-3 col-form-label"  >Salary</asp:Label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="salary"  ReadOnly="true"  runat="server" type="text" />
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Hourly Salary Rate</label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="hourly"   runat="server" ReadOnly="true" type="text" />
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Employeement Type Type</label>
								<div class="col-sm-9">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="ctype" ReadOnly="true"  runat="server" type="text" />
								</div>
							</div>
							<div id="days" class="mb-3 row"    runat="server">
								<asp:Label ID="Label19" ClientIDMode="Static"   runat="server"  class="col-sm-3 col-form-label" >Available Days</asp:Label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="availble" ReadOnly="true"  runat="server" type="text" />
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Annual Leave Entitlement</label>
								<div class="col-sm-9">
									<asp:Button ID="Button3"   runat="server" Text="Add"
										CssClass="button button1" Height="30px" Width="50px" OnClick="Button3_Click" /><br />
									<asp:Label   runat="server" ID="leave" Visible="false"></asp:Label>
								</div>
							</div>
							<h5>Job Contract</h5>
							<hr />
							<div class="mb-3 row">
								<label class="col-sm-3 col-form-label" >Send Interview</label>
								<div class="col-sm-9">
									<asp:TextBox class="form-control" ID="TextBox17"  runat="server" placeholder="Paste Interview Link" MaxLength="500"  TextMode="MultiLine" Rows="2" type="text" />
								</div>
							</div>
					...
					<div class="card-footer">
						<asp:Button   runat="server" class="btn btn-primary" OnClick="Button1_Click" Text="Send"></asp:Button>
						<asp:Button   runat="server" class="btn btn-secondary" Text="Reject"></asp:Button>
					</div>
				</div>
