<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="JobVacancies.aspx.cs" Inherits="JobVacancies" %>
						...
						<div class="card-body">
							<div class="theme-form">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<asp:TextBox runat="server" ID="TextBox23" CssClass="Textbox" MaxLength="500" TextMode="MultiLine" Rows="5" Width="90%" />
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<div class="input-group clockpicker">
											<asp:TextBox ID="TextBox7" runat="server" Width="90%" CssClass="Textbox"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<div class="input-group clockpicker">
											<asp:TextBox ID="TextBox111" runat="server" Width="90%" CssClass="Textbox"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<div class="input-group clockpicker">
											<asp:TextBox class="form-control" runat="server" ID="TextBox1" type="text" value="00:00" /><span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
										</div>
									</div>
								</div>
								<div class="mb-3 row">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<asp:TextBox runat="server" ID="TextBox2" CssClass="Textbox" MaxLength="500" TextMode="MultiLine" Rows="5" Width="90%" />
									</div>
								</div>
								<div class="mb-3 row">
									...
									<div class="mb-3 row">
										...
										<div class="mb-3 row">
											...
											<div class="mb-3 row">
												<label class="col-sm-3 col-form-label" for="inputPassword3">Typical Salary</label>
												<div class="col-sm-9">
