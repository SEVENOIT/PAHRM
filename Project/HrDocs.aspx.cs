...
public partial class HrDocs : System.Web.UI.Page
{
    SqlDataAdapter da;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    GridView2.DataBind();
        //}
        cmd.CommandText = "Select * from HRDocuments Where CID = '" + UserID + "'";
        cmd.Connection = con;
        cmd.Connection = con;
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        using (Stream fs = FileUpload1.PostedFile.InputStream)
        {
            using (BinaryReader br = new BinaryReader(fs))
            {
                ...
                {
                    string query = "insert into HRDocuments values (@CID,@Name, @ContentType, @Data)";
