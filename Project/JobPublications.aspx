<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobPublications.aspx.cs" Inherits="JobPublications" %>
			...
			<!-- Page Body Start-->
				...
				<div class="page-body"  >
					<div class="container-fluid">
						<div class="row" >
							<div class="col-6" style="vertical-align:central;">
								<div class="card">
									<div class="card-header pb-0">
										<h5 style="text-align:center;">Job Vacancies</h5>
 									</div>
									<div class="card-body">
										<div class="theme-form" runat="server">
											...
											<div class="mb-3">
												<label class="col-form-label pt-0" for="exampleInputEmail1">Positions</label>
												<asp:DropDownList class="form-control" ID="DropDownList1" runat="server" AutoPostBack="true">
												</asp:DropDownList>
											</div>
											<div class="mb-3">
												<label class="col-form-label pt-0" for="exampleInputEmail1">Job Type</label>
							...
							<div class="card-body">
								...
								<div runat="server" id="div2">
									<div class="table-responsive">
										<asp:GridView ID="Grid" runat="server" PageSize="10" DataKeyField="VID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnRowCommand="Grid_RowCommand" ItemStyle-BorderStyle="Solid" class="table table-bordered">
											<Columns>
												<%--<asp:BoundField HeaderText="Employee ID" DataField="EId" ID="EId"></asp:BoundField>--%>
												<asp:TemplateField HeaderText="Vacancy ID" ItemStyle-Width="150">
													<ItemTemplate>
														<asp:Label ID="VID" runat="server" Text='<%# Eval("VID") %>' DataField="VID" />
													</ItemTemplate>
												</asp:TemplateField>
												<asp:BoundField HeaderText="Company Name" DataField="Cname"></asp:BoundField>
												<asp:BoundField HeaderText="Job Title" DataField="JobTitle"></asp:BoundField>
												<asp:BoundField HeaderText="Location" DataField="Location"></asp:BoundField>
												<asp:BoundField HeaderText="Position" DataField="Position"></asp:BoundField>
												<asp:BoundField HeaderText="Employement Type" DataField="EmployementType"></asp:BoundField>
												<asp:BoundField HeaderText="Contract Type" DataField="ContractType"></asp:BoundField>
												<asp:BoundField HeaderText="Skills" DataField="Skills"></asp:BoundField>

												<asp:BoundField HeaderText="Salary" DataField="Salary"></asp:BoundField>
												<asp:TemplateField HeaderText="Apply Now">
													<ItemTemplate>
														<asp:Button Text="Apply" runat="server" class="btn btn-pill btn-info btn-air-info"  CommandName="Apply" CommandArgument="<%# Container.DataItemIndex %>" />
													</ItemTemplate>
												</asp:TemplateField>
