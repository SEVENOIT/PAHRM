                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group clockpicker">
                                            <asp:TextBox runat="server" ID="TextBox2" class="form-control" type="text" value="09:30" /><span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group clockpicker">
                                            <asp:TextBox runat="server" ID="TextBox3" class="form-control" type="text" value="09:30" /><span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
