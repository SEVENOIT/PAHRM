<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="TempLogin.aspx.cs" Inherits="TempLogin" %>
					...
					<div class="login-card">
						<form class="theme-form login-form" runat="server">
							...
							<div class="form-group">
								<label>Temporary Applicant ID</label>
								<div class="input-group">
									<span class="input-group-text"><i class="icon-email"></i></span>
									<asp:TextBox class="form-control" runat="server" ID="TextBox1" required="" placeholder="Test@gmail.com" />
								</div>
							</div>
