<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="JobViseRoster.aspx.cs" Inherits="JobViseRoster" %>
							...
							<div class="card-body">
								<div class="card-body">
									<div class="theme-form" runat="server">
										<div class="mb-3">
											<label class="col-form-label pt-0" for="exampleInputEmail1">Job Category</label>
										...
										<div class="mb-3">
											...
											<asp:TextBox class="form-control" type="date" ID="TextBox1" runat="server" AutoPostBack="true">
											</asp:TextBox>
										</div>
										<div class="mb-3">
											<label class="col-form-label pt-0" for="exampleInputEmail1">End Date</label>
											<asp:TextBox class="form-control" type="date" ID="TextBox3" runat="server" AutoPostBack="true">
											</asp:TextBox>
										</div>
