							...
							<div class="col-sm-12">
								...
								<div class="card">
									<div class="card-header pb-0">
										...
										<h4 style="text-align: center">Employeer OTP</h4>
									</div>
									<div class="card-body">
										<div class="theme-form">
											...
											<div class="mb-3 row">
												...
												<div class="col-sm-9">
													<asp:TextBox class="form-control" ID="reg" ReadOnly="true" runat="server" type="text" />
												</div>
											</div>
											<div class="mb-3 row">
											...
											<div class="mb-3 row">
												...
												<div class="col-sm-9">
													<asp:TextBox class="form-control" ID="email" ReadOnly="true" runat="server" type="text" />
												</div>
											</div>
											<div class="mb-3 row">
												<label class="col-sm-3 col-form-label" for="inputPassword3">Package Type</label>
												<div class="col-sm-9">
													<asp:TextBox class="form-control" ID="pType" ReadOnly="true" runat="server" type="text" />
												</div>
											</div>											
											<div class="mb-3 row">
												<label class="col-sm-3 col-form-label" for="inputPassword3">Price per employee</label>
												<div class="col-sm-9">
													<asp:TextBox class="form-control" ID="price" ReadOnly="true" runat="server" type="text" />
												</div>
											</div>
											<div class="mb-3 row">
												<label class="col-sm-3 col-form-label" for="inputPassword3">Start Date</label>
												<div class="col-sm-9">
													<asp:TextBox class="form-control" ID="sdate" ReadOnly="true" runat="server" type="text" />
												</div>
											</div>
											<div class="mb-3 row">
												<label class="col-sm-3 col-form-label" for="inputPassword3">Due Date</label>
												<div class="col-sm-9">
													<asp:TextBox class="form-control" ID="ddate" ReadOnly="true" runat="server" type="text" />
												</div>
											</div>
											<div class="mb-3 row">
												<label class="col-sm-3 col-form-label" for="inputPassword3">OTP</label>
												<div class="col-sm-9">
													<asp:TextBox class="form-control" ID="otp" runat="server" type="text" />
												</div>
											</div>
											<div class="card-footer">
												<asp:Button class="btn btn-primary" runat="server" Text="Send" OnClick="Button1_Click"></asp:Button>
