<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EPFETFReport.aspx.cs" Inherits="EPFETFReport" %>
					...
					<div class="col-sm-12">
						<div class="card">
							<div class="card-header pb-0">
								<h5>EPF ETF Report</h5>

								<hr />
							</div>
							<div class="card-body">
								<div runat="server" id="salaryDiv" class="table">
									...
									<div id="epfetfDiv" runat="server" class="table-responsive">
												...
												<div class="mb-3 row" style="text-align: center">
													...
													<div class="col-sm-9">
														<asp:Button ID="Button2" runat="server" Text="Search"
															class="btn btn-pill btn-outline-warning-2x btn-air-warning" OnClick="FullEPFETF" />
													</div>
										...
										<div id="epfetfSearchDiv" runat="server" class="table">
